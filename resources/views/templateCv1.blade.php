            ...
            <div class="row bg-content rounded">
                ...
                <div class="col-md-3 bg-secondary text-white py-4 rounded">
                    ...
                    <div class="cv-section mb-4">
                        ...
                        <textarea class="form-control @error('referrals') is-invalid @enderror" id="referrals" name="referrals" rows="3"
                            placeholder="Nhập người cố vấn">{{ old('referrals') }}</textarea>
                        @error('referrals')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
